...
# print(rw.sort_index())
# print((p.value_counts(normalize = True) * 100).round(2))
# print(rw.index.value_counts())
# print((g).round(0))

# def pokes(pokemon_type):
#     if "/" in pokemon_type:
#         return "yes"
#     return "no"
...
n = pd.Series(data = rw.index, index = [i for i in range(0,232)], name="mydates").dropna()
print(n.apply(myday).value_counts())